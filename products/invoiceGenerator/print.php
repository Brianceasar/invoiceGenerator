<?php 
  ...
  if($res->num_rows>0){
	  ...
	  $obj=new TanzanianShilling($row["GRAND_TOTAL"]);
  ...
  class PDF extends FPDF
  {
    function Header(){
      ...
      $this->Cell(50,10,"Byte Solution",0,1);
      $this->SetFont('Arial','',14);
      $this->Cell(50,7,"West Oysterbay,",0,1);
    ...
    function Footer(){
      ...
      $this->SetY(-50);
      $this->SetFont('Arial','B',12);
      $this->Cell(0,10,"for BYTE SOLUTION",0,1,"R");
      $this->Ln(15);
      $this->SetFont('Arial','',12);
      ...
      //Display Footer Text
      $this->Cell(0,10,"This is a computer generated invoice by Byte Solution ",0,1,"C");
